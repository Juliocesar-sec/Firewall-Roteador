...
# ==============================================================================
# Script de Configuração de Gateway no Debian 12 XFCE
# Com IP forwarding persistente, DHCP, UFW com NAT automático e Suricata
# Interfaces:
#   eth1 - modem 4G (recebe IP via DHCP)
...
echo "Iniciando configuração do Gateway no Debian 12 XFCE..."
echo "-------------------------------------------------"

# --- 1. Ativar IP forwarding persistente ---
